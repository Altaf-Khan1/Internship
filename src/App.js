  ...
  return (
    <div className="App">
      ...
      <div className="slideshow">
        ...
        <div class="slide">
          <img src="https://media.istockphoto.com/id/1182454657/photo/bohemian-living-room-interior-3d-render.jpg?s=612x612&w=0&k=20&c=qw37MGIiTL_jML3_Tbm4bM-jNLCrocSWj7DanhBr_bY=" alt="img"></img>
          <button className="contact">Contact Us</button>
        </div>
        <div class="slide">
